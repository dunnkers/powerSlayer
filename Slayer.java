...
@ScriptManifest(authors = {"Debauchery"}, name = "Slayer", version = 0.1, description = "")
public class Slayer extends Script implements PaintListener {

    /***************************Too many TODO's*********************************
     *  - Finish Slayer masters
     *  - Start the universal fighter base
     *  - Start mapping out paths
     *  - Paint
     *  - GUI (Some cool ideas...)
     **************************************************************************/

    // <editor-fold defaultstate="collapsed" desc="Constants etc...">
    ...
    // <editor-fold defaultstate="collapsed" desc="Slayer Masters">
    ...
    // <editor-fold defaultstate="collapsed" desc="Slayer Monsters">
    private static enum Monsters {
        ...
        DARK_BEAST("Dark beast", new Location(new RSTile(0, 0), 0)), //Moruner Armour...
        ...
        MOGRE("Mogre", new Location(new RSTile(0, 0), 0)), //Need to complete a 'mini quest'
        ...
        NECHRYAEL("Nechryael", new Location(new RSTile(0, 0),0)), //Needs nosepeg for walking past spectres...
        ...
        SCABARITES(" ", new Location(new RSTile(0, 0), 0)), //Need more infomation...
    ...
    // <editor-fold defaultstate="collapsed" desc="Slayer Requirements">
    ...
    // <editor-fold defaultstate="collapsed" desc="Universal Fighter">
    ...
    private void equip(Equipment equip) {
        for (RSItem item : inventory.getItems()) {
            for (String name : equip.getNames()) {
                if (item.getName().equalsIgnoreCase(name)) {
                    //Check that all equipment has 'Equip' option
                    item.doClick(true);
                    return;
                }
            }
