...
public enum Teleport {
    ...
    VARROCK_SPELL_3(TeleportType.VARROCK_SPELL, new RSTile(0, 0, 0), new Item[]{new Item(Item.NEEDS_TO_BE_EQUIPED, "Fire rune"), new Item("Law rune"), new Item("Air staff")}, 25),
    VARROCK_TAB(TeleportType.TAB, new RSTile(0, 0, 0), new Item[]{new Item("Varrock teleport")}),
    ROD_DUEL_AREA(TeleportType.OTHER, new RSTile(0, 0, 0), new Item(Item.COULD_BE_EQUIPED, "Ring of dueling"));
    private Item[] items;
    private RSTile loc;
