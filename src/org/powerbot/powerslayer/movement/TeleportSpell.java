...
public enum TeleportSpell implements ITeleport
{
    ...
    LUMBRIDGE(Magic.SPELL_LUMBRIDGE_TELEPORT, new RSTile(3221, 3220), 31, Rune.LAW, Rune.AIR, 3, Rune.EARTH),
    FALADOR(Magic.SPELL_FALADOR_TELEPORT, new RSTile(0, 0), 37, Rune.LAW, Rune.AIR, 3, Rune.WATER),
    CAMELOT(Magic.SPELL_CAMELOT_TELEPORT, new RSTile(2757, 3478), 45, Rune.LAW, Rune.AIR, 5),
    ARDOUGENE(Magic.SPELL_ARDOUGNE_TELEPORT, new RSTile(2661, 3303), 51, Rune.LAW, 2, Rune.WATER, 2);
    private RSTile loc;
    ...
    private TeleportSpell(int spellNum, RSTile loc, int magicLevel, Rune... runes) {
        this.loc = loc;
    ...
    private TeleportSpell(int spellNum, RSTile loc, int magicLevel, Object... runes) {
        this.loc = loc;
        this.book = Magic.Book.MODERN;
        this.spellNum = spellNum;
        this.magicLevel = magicLevel;
        for (int i = 0; i < runes.length; i++) {
            if (runes[i] instanceof Rune) {
                ...
                this.runes.put(rune, (old != null ? old.intValue() : 0) + count);
            }
        }
    }
