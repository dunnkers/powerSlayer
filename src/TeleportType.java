...
enum TeleportType {
	HOME_SPELL(Magic.SPELL_HOME_TELEPORT), VARROCK_SPELL(
			Magic.SPELL_VARROCK_TELEPORT), LUMBRIDGE_SPELL(
			Magic.SPELL_LUMBRIDGE_TELEPORT), FALADOR_SPELL(
			Magic.SPELL_FALADOR_TELEPORT), ARDOUGNE_SPELL(
			Magic.SPELL_ARDOUGNE_TELEPORT), TAB("Break"), OTHER();
